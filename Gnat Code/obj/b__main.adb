...
package body ada_main is
   ...
   E133 : Short_Integer; pragma Import (Ada, E133, "clean_air_E");
   E144 : Short_Integer; pragma Import (Ada, E144, "house_appliances_E");
   E146 : Short_Integer; pragma Import (Ada, E146, "house_exterior_E");
   E148 : Short_Integer; pragma Import (Ada, E148, "house_heating_E");
   E142 : Short_Integer; pragma Import (Ada, E142, "house_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "house__finalize_spec");
      begin
         F1;
      end;
      E148 := E148 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "house_heating__finalize_spec");
      begin
         F2;
      end;
      E146 := E146 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "house_exterior__finalize_spec");
      begin
         F3;
      end;
      E144 := E144 - 1;
      declare
         procedure F4;
         pragma Import (Ada, F4, "house_appliances__finalize_spec");
      begin
         F4;
      end;
      E133 := E133 - 1;
      declare
         procedure F5;
         pragma Import (Ada, F5, "clean_air__finalize_spec");
      begin
         F5;
      end;
      E117 := E117 - 1;
   ...
   begin
      ...
      Clean_Air'Elab_Body;
      E133 := E133 + 1;
      house_appliances'elab_spec;
      house_appliances'elab_body;
      E144 := E144 + 1;
      house_exterior'elab_spec;
      house_exterior'elab_body;
      E146 := E146 + 1;
      house_heating'elab_spec;
      house_heating'elab_body;
      E148 := E148 + 1;
      house'elab_spec;
      House'Elab_Body;
      E142 := E142 + 1;
...
--  BEGIN Object file/option list
   --   C:\Coursework\obj\clean_air.o
   --   C:\Coursework\obj\house_appliances.o
   --   C:\Coursework\obj\house_exterior.o
   --   C:\Coursework\obj\house_heating.o
   --   C:\Coursework\obj\house.o
   --   C:\Coursework\obj\main.o
   --   -LC:\Coursework\obj\
   --   -LC:\Coursework\obj\
